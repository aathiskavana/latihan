    ...
    <div class="container products-desc-layout">
        ...
        <div class="row">
            ...
            <ul class="nav nav-tabs-shadow nav-tabs-border projects-nav-tab">
                    ...
                    <li class="nav-item">
                      @if($project_type->name == 'Product Supplier')
            ...
            <div class="col-md-9">
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade active show" id="products-supplier">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="nav nav-tabs-outline projects-nav">
                    					@foreach($project_categories as $key=>$project_category)
                                        <li class="nav-item">
                                          @if($key == 0)
                                          <a class="nav-link active" data-toggle="tab" href="#project-{{str_slug($project_category->name)}}">{{$project_category->name}}</a>
                                          @else
                                          <a class="nav-link" data-toggle="tab" href="#project-{{str_slug($project_category->name)}}">{{$project_category->name}}</a>
                                          @endif
                                        </li>
                                        @endforeach
                                      </ul>
                            ...
                            @foreach($project_categories as $key=>$project_category)
                                @if($key == 0)
                                <div class="tab-pane fade show active" id="project-{{str_slug($project_category->name)}}">
                                @else
                                <div class="tab-pane fade show" id="project-{{str_slug($project_category->name)}}">
                                @endif
                                    <div class="row">
                                            @foreach($project_category->projects as $project)
                                            
                                            <div class="col-md-4 col-6 projects-hover">
                                                <img src="{{'/storage/'.$project->main_image}}" alt="{{$project->company}}" class="projects-detail-img">
                                                <div class="projects-overlay">
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <h6 class="text-white projects-mini-title">Company</h6>
                                                                <h6 class="text-white projects-mini-desc">{{$project->company}}</h6>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <h6 class="text-white projects-mini-title">Sector</h6>
                                                                <h6 class="text-white projects-mini-desc">{{$project->sector}}</h6>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <h6 class="text-white projects-mini-title">Year</h6>
                                                                <h6 class="text-white projects-mini-desc">{{$project->year}}</h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
