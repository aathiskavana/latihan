        ...
        <div class="row">
            <div class="col-md-3 col-12 offset-md-0">
                <ul class="nav nav-tabs-shadow nav-tabs-border projects-nav-tab">
                    <li class="nav-item">
                      <a class="nav-link active hover-card-products projects-nav-link" data-toggle="tab" href="#fo">
                        <h1 class="projects-title-number">1.</h1>
                        <h6 class="projects-icon-title">FIT OUT</h6>
                      </a>
                    </li>
                    
                    <li class="nav-item">
                      <a class="nav-link hover-card-products projects-nav-link" data-toggle="tab" href="#rf">
                        <h1 class="projects-title-number">2.</h1>
                        <h6 class="projects-icon-title">RETROFIT</h6>
                      </a>
                    </li>
                    
                    <li class="nav-item">
                      <a class="nav-link hover-card-products projects-nav-link" data-toggle="tab" href="#es">
                        <h1 class="projects-title-number">3.</h1>
                        <h6 class="projects-icon-title">ELECTRONIC SUPPLIER</h6>
                      </a>
                    </li>
                    
                    <li class="nav-item">
                      <a class="nav-link hover-card-products projects-nav-link" href="{{route('projects-product-supplier')}}">
                        <h1 class="projects-title-number">4.</h1>
                        <h6 class="projects-icon-title">PRODUCT SUPPLIER</h6>
                      </a>
                    </li>
                    
                    <li class="nav-item">
                      <a class="nav-link hover-card-products projects-nav-link" data-toggle="tab" href="#mt">
                        <h1 class="projects-title-number">5.</h1>
                        <h6 class="projects-icon-title">MAINTENANCE</h6>
                      </a>
                    </li>
                </ul>
            </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade active show" id="fo">
                        <div class="container-fluid">
                            <div class="row">
                                <h6 class="home-fo-title">Google</h6>
                                <div class="col-md-4 col-6">
                                    <img src="{{route('assets')}}/images/google-1.png" alt="Google" class="projects-detail-fo">
                                </div>
                                
                                <div class="col-md-4 col-6">
                                    <img src="{{route('assets')}}/images/google-2.png" alt="Google" class="projects-detail-fo">
                                </div>
                                
                                <div class="col-md-4 col-6">
                                    <img src="{{route('assets')}}/images/google-3.png" alt="Google" class="projects-detail-fo">
                                </div>
                                
                                <div class="col-md-4 col-6">
                                    <img src="{{route('assets')}}/images/google-4.png" alt="Google" class="projects-detail-fo">
                                </div>
                                
                                <div class="col-md-4 col-6">
                                    <img src="{{route('assets')}}/images/google-5.png" alt="Google" class="projects-detail-fo">
                                </div>
                                
                                <div class="col-md-4 col-6">
                                    <img src="{{route('assets')}}/images/google-6.png" alt="Google" class="projects-detail-fo">
                                </div>
                                
                                <div class="col-md-4 col-6">
                                    <img src="{{route('assets')}}/images/google-7.png" alt="Google" class="projects-detail-fo">
                                </div>
                                
                                <div class="col-md-4 col-6">
                                    <img src="{{route('assets')}}/images/google-8.png" alt="Google" class="projects-detail-fo">
                                </div>
                                
                                <div class="col-md-4 col-6">
                                    <img src="{{route('assets')}}/images/google-9.png" alt="Google" class="projects-detail-fo">
                                </div>
                            </div>
                            
                                
                                <div class="col-md-4 projects-hover">
                                    <img src="{{route('assets')}}/images/google-7.png" alt="Project" class="products-gate-1">
                                    <div class="projects-overlay">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h6 class="text-white projects-mini-title">Company</h6>
                                                    <h6 class="text-white projects-mini-desc">UMN University</h6>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h6 class="text-white projects-mini-title">Sector</h6>
                                                    <h6 class="text-white projects-mini-desc">Access Control</h6>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h6 class="text-white projects-mini-title">Year</h6>
                                                    <h6 class="text-white projects-mini-desc">2006</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 projects-hover">
                                    <img src="{{route('assets')}}/images/4-projects-8.png" alt="Project" class="products-gate-1">
                                    <div class="projects-overlay">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                                ...
                                <div class="col-md-4 projects-hover">
                                    <img src="{{route('assets')}}/images/4-projects-9.png" alt="Project" class="products-gate-1">
                                    <div class="projects-overlay">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                    ...
                    <div class="tab-pane fade" id="rf">
                      <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-4 projects-hover">
                                    <img src="{{route('assets')}}/images/4-projects-1.png" alt="Project UMN" class="products-gate-1">
                                    <div class="projects-overlay">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                                ...
                                <div class="col-md-4 projects-hover">
                                    <img src="{{route('assets')}}/images/4-projects-2.png" alt="Project UMN" class="products-gate-1">
                                    <div class="projects-overlay">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                                ...
                                <div class="col-md-4 projects-hover">
                                    <img src="{{route('assets')}}/images/4-projects-3.png" alt="Project UMN" class="products-gate-1">
                                    <div class="projects-overlay">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                                ...
                                <div class="col-md-4 projects-hover">
                                    <img src="{{route('assets')}}/images/4-projects-4.png" alt="Project UMN" class="products-gate-1">
                                    <div class="projects-overlay">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                                ...
                                <div class="col-md-4 projects-hover">
                                    <img src="{{route('assets')}}/images/4-projects-5.png" alt="Project UMN" class="products-gate-1">
                                    <div class="projects-overlay">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                                ...
                                <div class="col-md-4 projects-hover">
                                    <img src="{{route('assets')}}/images/4-projects-6.png" alt="Project UMN" class="products-gate-1">
                                    <div class="projects-overlay">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                                ...
                                <div class="col-md-4 projects-hover">
                                    <img src="{{route('assets')}}/images/4-projects-7.png" alt="Project" class="products-gate-1">
                                    <div class="projects-overlay">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
